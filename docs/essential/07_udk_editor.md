...
![alt text](/images/UDK/essential/image235.png "The main course")
...
![alt text](/images/UDK/essential/image51.png)
...
![alt text](/images/UDK/essential/image145.png)
...
These bring up the [Content Browser](08_content_browser.md), [Kismet](../guide/kismet/01_kismet.md), and [Matinee](../guide/udk/20_matinee.md) windows. Each of these will be explained in painful amounts of (relevant) detail in their own sections.

### 6 - Editor Visibility Options

![alt text](/images/UDK/essential/image115.png)
...
![alt text](/images/UDK/essential/image206.png)
...
![alt text](/images/UDK/essential/image250.png)
...
![alt text](/images/UDK/essential/image133.png)
...
![alt text](/images/UDK/essential/image4.png)
...
![alt text](/images/UDK/essential/image181.png "Almost as much fun as filing your taxes!")
...
![alt text](/images/UDK/essential/image183.png) - Use Selected Object In Content Browser - First, select the material/texture/mesh/whatever you intend to use in the viewer panel of the Content Browser. Then, click this arrow to autofill with its full UPK reference name (such as PhysicalMaterial'TestMap.PhysicalMaterials.StickyWalls').

![alt text](/images/UDK/essential/image98.png) - Find Object in Content Browser - Navigates to and selects the listed item in the content browser. This is the easiest way to jump around, because you don’t have to remember where every last material is buried.

![alt text](/images/UDK/essential/image135.png) - Clear Text - Wipes this box clean, almost like backspace or delete would do.

![alt text](/images/UDK/essential/image239.png) - Remove All Items From This Array - Clear the entire array. In the image above, the array is already empty.

![alt text](/images/UDK/essential/image33.png) - Add a New Item - For arrays, such as StaticMeshActors with multiple Materials or a map with multiple spawn points, you may need to manually create open slots. Clicking this will create a slot which has a few more options, as shown below.

![alt text](/images/UDK/essential/image116.png) - Create a Copy of This Item - Couldn’t have said it better myself.

![alt text](/images/UDK/essential/image153.png) - Remove This Item - As advertised.

![alt text](/images/UDK/essential/image198.png) - Insert a New Item Before This Item - Really stunning iconographic work here.
...
![alt text](/images/UDK/essential/image258.png)
