...
As will be explained in painful amounts of detail in the [Blender sections]() (should you choose to read them), materials are a way to handle all of the visual properties of a mesh. For right now, we’re just going to use existing materials and not really worry about what they’re made of. To make your own, see the [Custom Materials section]().
...
This will be explored in much more detail in the [Custom Materials section]().
