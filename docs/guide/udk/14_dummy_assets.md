...
<CaptionImageComponent src=/images/UDK/advanced/image91.png caption="Dummy Thicc"/>
...
Recall that the word “Cooked” refers to the fact that these packages have been encrypted. This means that the Dummy Assets method is not as simple as copying Dropshot out of CookedPCConsole and opening it in UDK, but it is nearly that simple. **Martinn** took the time to pass all of the Rocket League maps through a decryption tool (discussed [later in this guide](../decryption/01_decryption.md)), and then organized the resulting pieces into this library.
...
<CaptionImageComponent src=/images/UDK/advanced/image78.png caption="Locked and loaded and ready to get dumb"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image241.png caption="Bag em and tag em"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image23.png caption="Not all who wander are lost"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image163.png caption="Filter to Material Instances and Materials, then click dat arrow"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image53.png caption="Not your grandpappy’s cube ball"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image180.png/>
<CaptionImageComponent src=/images/UDK/advanced/image255.png caption="Monkeyball 2020"/>
