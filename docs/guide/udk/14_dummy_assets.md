...
![Steps on how to add dummy assets](/images/udk/advanced/dummy_assets_install.png "Dummy Thicc")
...
![Fully load action on HoopsStadium_P](/images/udk/advanced/dummy_assets_fully_load.png "Locked and loaded and ready to get dumb")
...
![Custom tag on an invisible dummy asset](/images/udk/advanced/dummy_assets_tag.png "Bag em and tag em")
...
![Scene window in the content browser with the custom tags](/images/udk/advanced/dummy_assets_scene.png "Not all who wander are lost")
...
![Steps on assigning a dummy material](/images/udk/advanced/dummy_materials_assign.png "Filter to Material Instances and Materials, then click dat arrow")
...
To further complicate matters, many of these materials will simply not work on certain types of objects. Some are meant for particle systems, others for volumetric effects, and others are controlled by code within the game that we have no way of accessing. For this reason, I recommend testing materials on what I generally refer to as UV cubes. The CSG brush will work fine for this, or you can create and import your own that will be more useful. Or, take mine: [This is for you](https://drive.google.com/file/d/1sS6KkDMfkzkhJfuBMicUa56FpdiDXvO-/view)

![UV Cube with the Rocket League ball texture](/images/udk/advanced/uv_cube_ball.png "Not your grandpappy’s cube ball")
...
![UV map of the game ball for a monkey mesh](/images/udk/advanced/uv_map_ball_monkey.png)

---
![Game ball (dummy material) texture on a monkey](/images/udk/advanced/dummy_material_ball_on_monkey.png "Monkeyball 2020")
