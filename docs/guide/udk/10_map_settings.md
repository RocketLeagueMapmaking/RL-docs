...
![Blue arrow to create map info](/images/udk/basics/newmapinfo.png "Very informative, much TA")
...
![Map with and without a Scene Capture Cube Map Actor](/images/udk/basics/scenecapturecubemapactor.jpg "A time for reflection")
...
![Scene Capture Cube Map Actor properties](/images/udk/basics/mapsettings_sccma.png "Capture deez cubez")
