...
![Screenshot of the game Gears of war](/images/udk/basics/gears_of_war.png)
...
![Build icon](/images/udk/basics/icon_build_lighting.png "Icon to build lighting in the menu")
...
![Lighting build result with errors and warnings](/images/udk/basics/lighting_build_result.png "Task Failed Successfully!")
...
![Missing lightmass importance volume error](/images/udk/basics/lighting_build_lightmass_error.png)
