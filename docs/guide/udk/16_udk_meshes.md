...
![The right click menu on a StaticMesh](/images/udk/advanced/reimport_sm.png "A very 'handy' tool")
...
![UDK Tools menu](/images/udk/advanced/reimport_auto_setting.png "'Truly Automatic'")
