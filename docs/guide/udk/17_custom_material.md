...
<CaptionImageComponent src=/images/UDK/advanced/image124.png caption="Don’t believe his lies"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image41.png caption="Yes"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image185.png caption="Details, details, details..."/>

**Fill in the information in the popup window, making sure to put this Material Instance into your map project.**

<CaptionImageComponent src=/images/UDK/advanced/image15.png caption="At long last, we meet again for the first time, for the last time"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image199.png caption="UDK == Null sec"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image114.png caption="Fur Elise"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image119.png caption="Import-ant screenshot"/>
...
<CaptionImageComponent src=/images/UDK/advanced/image148.png caption="It’s happening fur real now"/>
