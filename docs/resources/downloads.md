...
### Park_P Slightly-Less-Dummy Assets

[Download](https://drive.google.com/open?id=1rpQzqHgoRgpOBSHEpeDwvRtG3sYUXacl)

### Salty Shores Dummy Assets

Just unzip and paste it alongside the rest of the Dummy Assets maps:
...
:::tip
Don't forget to put the StickyWalls physical material on the Coll mesh, and use the setting "Hidden Game" to make it invisible.
:::
