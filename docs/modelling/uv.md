...
![alt text](../.vuepress/public/images/image7.png)

*(u,v) = (0.5 + atan2(dx,dz)/2π, 0.5-asin2(dy)/π) . This will be on the test.*

The reason we care about UV maps is it’s how we tell UDK to display textures on a 3D surface. Without them, there is no texture and we’re stuck in a sad world of solid tones.

## A Brief Refresher
Recall these from the [Blender Key Terms](intro.html#key-terms) section :
...
![alt text](../.vuepress/public/images/image42.png)
...
![alt text](../.vuepress/public/images/image64.png)
![alt text](../.vuepress/public/images/image56.png)
...
![alt text](../.vuepress/public/images/image253.png)
...
![alt text](../.vuepress/public/images/image189.png)
...
![alt text](../.vuepress/public/images/image92.png)
...
![alt text](../.vuepress/public/images/image144.png)
...
![alt text](../.vuepress/public/images/image12.png)
