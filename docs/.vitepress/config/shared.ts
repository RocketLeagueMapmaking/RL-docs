...
export const GITHUB_CMS_BRANCH = 'editor'

export const WEBSITE_LOGO_PATH = '/icons/logo_rlmm_round_144.png'

export const WEBSITE_URL = 'https://rocketleaguemapmaking.com'
